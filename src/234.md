...
![Teaser: SC-GS 整体效果展示](assets/234/fig1_teaser.png)
## 第一节：背景知识——你需要先理解这些概念
...
> **参考**：详细推导与几何直觉（旋转矩阵 9 元素 → 6 DoF）见 mathematics_basic_for_ML《[旋转矩阵与 6DoF](https://caterpillarstudygroup.github.io/mathematics_basic_for_ML/Geometry/RotationMatrix.html)》；四元数表示与运算见《[四元数](https://caterpillarstudygroup.github.io/mathematics_basic_for_ML/Geometry/Quaternion.html)》。
...
![Pipeline: SC-GS 方法概览](assets/234/fig2_pipeline.png)
（见图 2）：
...
![Motion Editing: 运动编辑效果展示](assets/234/fig5_motion_editing.png)
（Motion Editing）
...
![Ablation: 消融实验可视化](assets/234/fig6_ablation.png)
（Ablation Study）
...
![Qualitative Comparison on D-NeRF](assets/234/fig3_qualitative.png)
