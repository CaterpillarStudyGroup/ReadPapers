...
**效果:** 网表1
在药内春生成中、的文本一致1单内容生成中，1和的文本“致生比较好任有明盘下降，但4没向介机:由于1和牛调整 5spatia 关层的权车因此能更好地捕获复的ID特征
实验三、Ablatio. LRA + Weight fusisn2.ED- LoRA +weia ht fusim3.ED-LRA + gradent fusim效果.@麦z@结记· ED编码和 awadient fusi能好地保留D特征
图评价指标
CLIP-Score: T/I 相似度生成图家与taraet conept 相似度CIIP
.  
.  
.  
.  
